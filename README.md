...
* *Dynamic Pricing:* Calculates the ticket price based on the customer's age using conditional statements (if, elif, else).
* *Total Sum:* Accumulates the price of each individual ticket to display a grand total at the end of the execution.

## 💰 Pricing Table
* *Children (under 12 years old):* $8,000
* *Adults (12 to 59 years old):* $12,000
* *Seniors (60 years and older):* $9,000
